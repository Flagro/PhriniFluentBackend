...
class WordGroup(models.Model):
    ...
    is_global = models.BooleanField(
        default=False
    )  # Indicates if the word group is public
...
class WordGroupDescription(models.Model):
    word_group = models.ForeignKey(
        WordGroup, on_delete=models.CASCADE, related_name="descriptions"
    )
...
class Word(models.Model):
    word_group = models.ForeignKey(
        WordGroup, on_delete=models.CASCADE, related_name="words"
    )
...
class WordDescription(models.Model):
    word = models.ForeignKey(
        Word, on_delete=models.CASCADE, related_name="descriptions"
    )
    language = models.ForeignKey(Language, on_delete=models.CASCADE)
    description_text = models.TextField()
