...
class WordGroupAdmin(admin.ModelAdmin):
    list_display = ('id', 'name', 'is_global', 'owner',)
    list_filter = ('is_global', 'languages',)
...
class WordAdmin(admin.ModelAdmin):
    list_display = ('id', 'text', 'word_group',)
...
class WordGroupDescriptionAdmin(admin.ModelAdmin):
    list_display = ('id', 'word_group', 'language', 'description_text',)
    list_filter = ('word_group', 'language',)
    search_fields = ('description_text',)

@admin.register(WordDescription)
class WordDescriptionAdmin(admin.ModelAdmin):
    list_display = ('id', 'word', 'language', 'description_text',)
    list_filter = ('word', 'language',)
    search_fields = ('description_text',)
